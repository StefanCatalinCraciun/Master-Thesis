...
mutable struct Model
    ...
    """
    Nx::Union{Nothing, Int}
    Ny::Union{Nothing, Int}
    Nb::Union{Nothing, Int}
    W0::Union{Nothing, Float64}
    Q::Union{Nothing, Array{Float64, 2}}
    Kappa::Union{Nothing, Array{Float64, 2}}
    Dkappax::Union{Nothing, Array{Float64, 2}}
    Dkappay::Union{Nothing, Array{Float64, 2}}
    Drhox::Union{Nothing, Array{Float64, 2}}
    Drhoy::Union{Nothing, Array{Float64, 2}}
    Rho::Union{Nothing, Array{Float64, 2}}
    Alpha1x::Union{Nothing, Array{Float64, 2}}
    Alpha1y::Union{Nothing, Array{Float64, 2}}
    Alpha2x::Union{Nothing, Array{Float64, 2}}
    Alpha2y::Union{Nothing, Array{Float64, 2}}
    Eta1x::Union{Nothing, Array{Float64, 2}}
    Eta1y::Union{Nothing, Array{Float64, 2}}
    Eta2x::Union{Nothing, Array{Float64, 2}}
    Eta2y::Union{Nothing, Array{Float64, 2}}
    dx::Union{Nothing, Array{Float64, 1}}
    dy::Union{Nothing, Array{Float64, 1}}
