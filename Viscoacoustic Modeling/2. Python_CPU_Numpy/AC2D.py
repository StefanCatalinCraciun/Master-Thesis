...
class Ac2d:
    ...
    def Ac2dvx(Ac2d, Model):
        ...
        # Scale with inverse density
        Ac2d.vx += Model.Dt * (1.0 / Model.Rho) * Ac2d.exx + Model.Dt * Ac2d.thetax * Model.Drhox
        Ac2d.thetax = Model.Eta1x * Ac2d.thetax + Model.Eta2x * Ac2d.exx
    ...
    def Ac2dvy(Ac2d, Model):
        ...
        # Scale with inverse density
        Ac2d.vy += Model.Dt * (1.0 / Model.Rho) * Ac2d.eyy + Model.Dt * Ac2d.thetay * Model.Drhoy
        Ac2d.thetay = Model.Eta1y * Ac2d.thetay + Model.Eta2y * Ac2d.eyy
    ...
    def Ac2dstress(Ac2d, Model):
        ...
        # Update pressure
        Ac2d.p += Model.Dt * Model.Kappa * (Ac2d.exx + Ac2d.eyy) \
                + Model.Dt * (Ac2d.gammax * Model.Dkappax + Ac2d.gammay * Model.Dkappay)

        # Update gammax and gammay
        Ac2d.gammax = Model.Alpha1x * Ac2d.gammax + Model.Alpha2x * Ac2d.exx
        Ac2d.gammay = Model.Alpha1y * Ac2d.gammay + Model.Alpha2y * Ac2d.eyy
