...
class Ac2d:
    ...
    def Ac2dvx(Ac2d, Model):
        ...
        Ac2dvx_Cython(nx, ny, Model.Dt, Ac2d.vx, Model.Rho, Ac2d.exx, Ac2d.thetax, Model.Drhox, Model.Eta1x, Model.Eta2x)
    ...
    def Ac2dvy(Ac2d, Model):
        ...
        # Scale with inverse density and advance one time step
        Ac2dvy_Cython(nx, ny, Model.Dt, Ac2d.vy, Model.Rho, Ac2d.eyy, Ac2d.thetay, Model.Drhoy, Model.Eta1y, Model.Eta2y)
    ...
    def Ac2dstress(Ac2d, Model):
        ...
        Ac2dstress_Cython(nx, ny, Model.Dt, Ac2d.p, Model.Kappa, Ac2d.exx, Ac2d.eyy, Ac2d.gammax, Model.Dkappax, Ac2d.gammay, Model.Dkappay, Model.Alpha1x, Model.Alpha2x, Model.Alpha1y, Model.Alpha2y)
        '''
        for i in range(nx):
            for j in range(ny):
