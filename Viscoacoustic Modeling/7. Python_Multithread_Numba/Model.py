...
class Model:
    def __init__(self,vp):
        ...
        self.Dkappax = np.zeros((self.Nx, self.Ny)) 
        self.Dkappay = np.zeros((self.Nx, self.Ny)) 
        self.Drhox = np.zeros((self.Nx, self.Ny)) 
        self.Drhoy = np.zeros((self.Nx, self.Ny)) 
        self.Rho = np.zeros((self.Nx, self.Ny)) 
        self.Alpha1x = np.zeros((self.Nx, self.Ny)) 
        self.Alpha1y = np.zeros((self.Nx, self.Ny)) 
        self.Alpha2x = np.zeros((self.Nx, self.Ny)) 
        self.Alpha2y = np.zeros((self.Nx, self.Ny)) 
        self.Eta1x = np.zeros((self.Nx, self.Ny)) 
        self.Eta1y = np.zeros((self.Nx, self.Ny)) 
        self.Eta2x = np.zeros((self.Nx, self.Ny)) 
        self.Eta2y = np.zeros((self.Nx, self.Ny)) 
        self.dx = np.zeros(self.Nx)  
        self.dy = np.zeros(self.Ny)  
        self.Dx = 0. 
        self.Dt = 0.     
    ...
    def Model_maxwell (self, vp, rho, Q, Dx, Dt, W0, Nb):
        ...
        model = Model(vp)                                 # Object to instantiate
