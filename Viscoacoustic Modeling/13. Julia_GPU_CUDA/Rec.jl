...
mutable struct Rec
    ...
    Nb::Int
    dt::Float64
    wavefield::Array{Float64, 3}
    trace::Array{Float64, 1}
    trace_analytical::Array{Float64, 1}
end

function Rec(rx::Array{Int, 1}, ry::Array{Int, 1}, nt::Int, resamp::Int, sresamp::Int, nx::Int, ny::Int, dx::Float64, Nb::Int, dt::Float64, gx::Int=0, gy::Int=0)
    nr = length(rx)
...
function rec_trace!(rec::Rec, it::Int, snp::Array{Float64, 2})
...
function rec_seismogram!(rec::Rec, it::Int, snp::Array{Float64, 2})
    if rec.pit > rec.nt - 1
        return "ERR"
    end
...
function rec_wavefield!(rec::Rec, it::Int, snp::Array{Float64, 2})
    if rec.sresamp <= 0
        return "OK"
    end
