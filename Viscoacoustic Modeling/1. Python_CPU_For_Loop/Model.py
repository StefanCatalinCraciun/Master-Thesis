...
class Model:
    ...
    def Model_maxwell (self, vp, rho, Q, Dx, Dt, W0, Nb):
        ...
        to perform 2D viscoacoustic modeling.
        ...
        The absorbing boundaries is constructed using a visco-elastic medium with
        relaxation specified by a Maxwell mechanism whith 
    ...
    def Model_sls(self, vp, rho, Q, Dx, Dt, W0, Nb):
        ...
        relaxation specified by a standard-linear solid, whith
        a time dependent density.
        ...
        tau_sigma (𝜏_𝜎) and tau_epsilon (𝜏_𝜀).
